...
local list = {
	...
	"streets:roadwork_blinking_light_on", "streets:roadwork_blinking_light_off", "streets:roadwork_pylon", "realchess:chessboard", "default:water_source", "default_tweaks:protect"
}
