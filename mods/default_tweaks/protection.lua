...
if minetest.settings:get_bool("default_tweaks.overwrite_item", false) then
	dofile(minetest.get_modpath("default_tweaks").."/builtin-item.lua")--this will overwrite the default item.lua. copied from 5.6.0
end
...
local list = {
	...
	"streets:roadwork_blinking_light_on", "streets:roadwork_blinking_light_off", "streets:roadwork_pylon", "realchess:chessboard", "default:water_source", "default_tweaks:protect", "package:package"
}
--"default:glass","xpanes:glass_pane", "xpanes:glass_pane_flat", "xpanes:pane", "xpanes:pane_flat", "doors:door_glass_a", "doors:door_glass_b", 
local blacklist = {}
for i = 1, 4 do
...
local exempttbl = {}
function default_tweaks.exempt_node_dig(pos, node, digger)
